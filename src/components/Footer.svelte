<footer class="bg-gray-100 pt-32 pb-6 mt-6">
  <div class="container mx-auto px-4">
    <!-- Logo Section -->
    <div class="mb-8">
      <img src="/images/company_logo.jpg" alt="5CS Group" class="h-20 object-cover object-top" style="clip-path: inset(0 0 15% 0);" />
    </div>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
      ...
      <!-- Legal Links -->
      <div>
        <h3 class="font-medium mb-4 text-lg">Jogi információk</h3>
        <ul class="space-y-2 text-base text-gray-600">
          <li><a href="/adatvedelmi-tajekoztato" class="hover:text-[#DC0000]">Adatvédelmi tájékoztató</a></li>
          <li><a href="/altalanos-szerzodesi-feltetelek" class="hover:text-[#DC0000]">Általános szerződési feltételek</a></li>
        </ul>
        <div class="mt-6">
          <p class="text-base text-gray-600">konkurencia © – weboldal fejlesztő: azEgyetlen</p>
          <div class="flex space-x-4 mt-2">
            <a href="https://instagram.com" class="text-gray-600 hover:text-[#DC0000]">
            ...
            <a href="https://facebook.com" class="text-gray-600 hover:text-[#DC0000]">
              <svg class="h-5 w-5" fill="currentColor" viewBox="0 0 24 24">
